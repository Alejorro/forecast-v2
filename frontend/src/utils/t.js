...
const t = {
  ...
  ventas: {
    ...
    allQuarters:       'Todos los quarters',
    clearFilters:      'Limpiar filtros',
    count:             (n) => `${n} venta${n !== 1 ? 's' : ''}`,
    loadingList:       'Cargando ventas...',
    noMatchFilters:    'Ninguna venta coincide con los filtros.',
    noMatchHint:       'Intentá ajustar la búsqueda o los filtros.',
    emptyTitle:        'Sin ventas',
    emptyHint:         'Sincronizá con Odoo para importar ventas.',
    kpi: {
      totalEmpresa:     'Total Empresa',
      totalFacturado:   'Total Facturado',
      totalPorFacturar: 'Total por Facturar',
    ...
    columns: {
      ...
      amountOriginal: 'Total original',
      currency:       'Moneda',
      amountUsd:      'USD oficial',
      date:           'Fecha',
    ...
    drawer: {
      ...
      sectionOdoo:     'Datos Odoo',
      sectionInternal: 'Campos internos',
      fields: {
        reference:      'Referencia',
        client:         'Cliente',
        seller:         'Vendedor (Odoo)',
        sellerLinked:   'Vendedor (sistema)',
        brand:          'Brand',
        ...
        amountOriginal: 'Monto original',
        amountUsd:      'USD oficial',
        fxRate:         'Tipo de cambio',
        fxRateDate:     'Fecha del tipo de cambio',
